...
Aside from lectures 1 and 3, which use code introduced here, all lecture notebooks and tutorials require installing the [sequence-space Jacobian toolkit](https://github.com/shade-econ/sequence-jacobian).
