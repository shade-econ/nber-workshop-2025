...
as described in lecture 3 slides and worked through in lecture 3 notebook
for special case of intertemporal MPCs.

Here, computes sequence-space Jacobian for any list of shocked
